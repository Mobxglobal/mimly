...
export function buildSimplePrompt(
  ...
  return [
    ...
    "1. The caption MUST be a complete, self-contained thought.",
    "2. It must include BOTH:",
    "   * a setup (e.g. \"When you...\")",
    "   * AND a consequence, realization, or outcome.",
    "3. NEVER stop at the setup.",
    "",
    "INVALID examples (DO NOT DO THIS):",
    "* \"When you realize the client forgot to mention\"",
    "* \"When everything seems fine but\"",
    "* \"When you finally finish the job and\"",
    "",
    "These are incomplete and must NEVER be returned.",
    "",
    "VALID examples:",
    "* \"When you realize the client forgot to mention one small detail\"",
    "* \"When everything seems fine but something feels off\"",
    "* \"When you finish the job and notice one last mistake\"",
    "",
    "4. Completeness is MORE important than brevity.",
    "   Do NOT shorten the sentence by removing the ending or key detail.",
    "",
    "5. Keep the caption concise so it fits comfortably within 2 lines,",
    "   but ONLY after the full idea is expressed.",
    "",
    "6. Avoid:",
    "* unfinished thoughts",
    "* trailing connectors (and, but, so, because)",
    "* broken or split sentence fragments",
    "* awkward conversational phrasing",
    "",
    "7. The caption should feel natural, relatable, and human — not generic or robotic.",
    "",
    "8. If using punctuation like quotes, they MUST be properly closed.",
    isEightyFourYears
