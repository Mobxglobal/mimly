...
function getDownloadHref(
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
      ...
      <text x="540" y="146" text-anchor="middle" fill="#f8fafc" font-family="Inter" font-size="48" font-weight="700">${top}</text>
      <text x="540" y="944" text-anchor="middle" fill="#e2e8f0" font-family="Inter" font-size="42" font-weight="700">${bottom}</text>
      <text x="540" y="540" text-anchor="middle" fill="#64748b" font-family="Inter" font-size="36">${safeTitle}</text>
    </svg>
  `;
